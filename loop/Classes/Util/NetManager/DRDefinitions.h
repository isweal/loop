...
#define DribbbleSDKLogsEnabled 0
...
typedef void(^DRResponseHandler)(DRApiResponse *apiResponse);
...
static NSInteger const kDefaultUsersPerPageNumber = 20;
static NSInteger const kUploadFileBytesLimitSize = 8;
